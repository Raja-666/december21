...
const ItemsCollection = ({itemData}) => {
  console.log('fdfdsfsfds' , itemData)
                ...
                <div className={`viewItemscard ${isFilterView ? 'collapseWidth' : 'fullWidth'}`}>
                  <div className="form-inline">
                    <div className="form-group formInputs mr-3 flex-grow-1">
                      ...
                      {/* Input search filter dropdown start*/}

                      {/* <div className="collectionFilter filterSubmenu">
                        <div className="filterRow d-flex align-items-center">
                          <div>
                            <h3 className="heading">Ear Cuffs</h3>
                            <p>Ear</p>
                          </div>
                          <div className="ml-auto text-right">
                            <p className="mb-2">Floor:<span>0.9 ETH</span></p>
                            <p>Rarity <span>12</span></p>
                          </div>
                        </div>
                        <hr />
                        <div className="filterRow d-flex align-items-center">
                          <div>
                            <h3 className="heading">Elf Ear</h3>
                            <p>Ear</p>
                          </div>
                          <div className="ml-auto text-right">
                            <p className="mb-2">Floor:<span>1.1 ETH</span></p>
                            <p>Rarity 12</p>
                          </div>
                        </div>
                        <hr />
                        <div className="filterRow d-flex align-items-center">
                          <div>
                            <h3 className="heading">Clear Glasses</h3>
                            <p>Face</p>
                          </div>
                          <div className="ml-auto text-right">
                            <p className="mb-2">Floor:<span>1.093 ETH</span></p>
                            <p>Rarity <span>1</span></p>
                          </div>
                        </div>
                      </div> */}

                        {/* Input search filter dropdown end*/}
                    </div>
                    ...
                    <div className="form-group formInputs mr-3 mb-2">
                      {/* <Input type="select">
                       ...
                       <Dropdown isOpen={dropdownOpen} toggle={toggleDropdown} className='customdropdown'>
                        <DropdownToggle>
                            <span>Price: Low - High</span> <i className={`fas ${dropdownOpen ? 'fa-angle-up' : 'fa-angle-down'}`}></i>
                        </DropdownToggle>
                        <DropdownMenu>
                            ...
                            <DropdownItem><div>Rarity: Low - High</div><div><CheckTick /></div></DropdownItem>
                            <DropdownItem><div>Rarity: High - Low</div><div><CheckTick /></div></DropdownItem>
                            ...
                            <DropdownItem><div>Most Popular</div><div><CheckTick /></div></DropdownItem>
                            <DropdownItem><div>Recently Sold</div><div><CheckTick /></div></DropdownItem>
                            <DropdownItem><div>Most Viewed</div><div><CheckTick /></div></DropdownItem>
                            <DropdownItem><div>Most Favorited</div><div><CheckTick /></div></DropdownItem>
                            <DropdownItem><div>Ending Soon</div><div><CheckTick /></div></DropdownItem>
                            <DropdownItem><div>Highest Bid</div><div><CheckTick /></div></DropdownItem>
                            <DropdownItem><div>Highest Last Sale</div><div><CheckTick /></div></DropdownItem>
                  ...
                  <TabContent activeTab={activeTab}>
                    ...
                    <TabPane tabId="2">
                      <GridViewItem filterview={isFilterView} data={itemData} />
                    </TabPane>
                  </TabContent>
                  <div className="selectFloatCnt d-flex justify-content-between">
                       ...
                       <div className='ml-3'>
                        <div class="form-group formInputs mb-0" style={{width: "50px"}}><Input className='form-control' type='text' /></div>
                       </div>
                       </div>
                      <div className="d-flex align-items-center">
                        <a className="mr-2">Cancel</a>
                        <button className='btnPrimaryLabel'><span class="fw-600">Sweep</span> 1.65 ETH</button>
                      </div>                     
                    </div>
