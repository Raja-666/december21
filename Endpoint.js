...
const NeuroNFT = api.injectEndpoints({
  ...
  // 
export const {useNftCreateMutation, useSubmitKYCMutation , useCollectionListMutation, useCreateNFTMutation , useHomeColListMutation , useFullColListMutation , useGetNftDetailMutation} = NeuroNFT;